...
export default async function OperatorOpinionPublicPage({
  searchParams,
}: {
  ...
  const data = await loadListPageData("public", {
    limit: pageSize,
  ...
  return (
    <>
      ...
      <OpinionListPageShell
        ...
        onRefreshHref="/operator/opinion/public"
      />
    </>
  );
}
