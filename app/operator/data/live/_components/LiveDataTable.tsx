...
export default function LiveDataTable({
  ...
  const columns = React.useMemo<ColumnDef<LiveRow>[]>(
    () => [
      ...
      numericColumn("liveDuration", "开播时长", { float: true }),
      numericColumn("acu", "ACU", { float: true, size: 90 }),
      numericColumn("exposureUsers", "曝光人数", { wan: true }),
      numericColumn("exposureCount", "曝光次数", { wan: true }),
      numericColumn("enterRoomUsers", "进直播间人数", { wan: true, size: 120 }),
      numericColumn("enterRoomCount", "进直播间次数", { wan: true, size: 120 }),
      numericColumn("enterRoomRate", "进直播间转化率", { float: true, suffix: "%", sortable: false, size: 130 }),
      numericColumn("avgWatchDuration", "人均观看时长", { float: true, size: 120 }),
      numericColumn("tipUsers", "打赏人数", { sortable: false }),
      numericColumn("tipCount", "打赏次数", { sortable: false }),
      numericColumn("newFans", "新增粉丝"),
      {
        accessorKey: "note",
        header: "团号",
        size: 100,
